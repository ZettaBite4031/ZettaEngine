...
namespace Editor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _AppDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\ZettaEditor\";
        ...
        private static void ReadProjectData()
        {
            if (File.Exists(_projectDataPath))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.zetta\icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.zetta\screenshot.png");
